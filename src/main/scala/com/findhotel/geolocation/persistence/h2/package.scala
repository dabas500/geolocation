...
package object h2 {
  ...
  final class GeoLocationTable(tag: Tag) extends Table[GeoLocationDBRepr](tag, "TOPIC"){
    def locationId:Rep[Long] = column[Long]("LOCATION_ID", O.PrimaryKey, O.AutoInc)
    ...
    override def * = (locationId, ipAddress,countryCode, country, city, latitude, longitude, mysteryValue).mapTo[GeoLocationDBRepr]
  }
